...
export const baseHeaderClasses = 'relative h-12 bg-orange-600 text-white xl:h-10';
...
export const buttonClasses =
  'inline-block no-underline font-medium rounded min-w-[32px] sm:min-w-[64px] px-4 leading-9 cursor-pointer text-orange-600';
